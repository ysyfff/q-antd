...
exports.default = function (ComposedComponent) {
  ...
  return (0, _mobxReact.inject)('model', 'duplexer', 'validateOnChange', 'validateOnBlur')((0, _mobxReact.observer)((_class = function (_React$Component) {
      ...
      value: function render() {
        ...
        var _props2 = this.props,
          ...
          return 1;
            ...
            remain = _objectWithoutProperties(_props2, ['duplex', 'model', 'children', 'onChange', 'validateOnChange', 'validateOnBlur', 'noDefault']);
        ...
        var existed = expanded ? true : dynamic ? model.hasOwnProperty(duplex[0]) : staticWith2Param ? model.hasOwnProperty(keys1) && model.hasOwnProperty(keys2) : model.hasOwnProperty(duplex);
            ...
            onChange: function onChange(e, options) {
              ...
              switch (componentName) {
                ...
                default:
                  v = e;
                  var _msg = '未捕获组件类型';
                  console.error(_msg + ': ' + componentName);
                  break;
              }
    ...
    return _class;
  }(_react2.default.Component), (_applyDecoratedDescriptor(_class.prototype, 'createKeyValueViaDot', [_coreDecorators.autobind], Object.getOwnPropertyDescriptor(_class.prototype, 'createKeyValueViaDot'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'getExpandedMapValue', [_coreDecorators.autobind], Object.getOwnPropertyDescriptor(_class.prototype, 'getExpandedMapValue'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'isValidDuplexString', [_coreDecorators.autobind], Object.getOwnPropertyDescriptor(_class.prototype, 'isValidDuplexString'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'getKeyCodeFromProps', [_coreDecorators.autobind], Object.getOwnPropertyDescriptor(_class.prototype, 'getKeyCodeFromProps'), _class.prototype)), _class)));
};