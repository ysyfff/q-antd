  ...
  _createClass(FormItem, [{
    ...
    value: function render() {
      var _props3 = this.props,
          ...
          style = _props3.style,
          remain = _objectWithoutProperties(_props3, ['children', 'labelSpan', 'align', 'label', 'fields', 'model', 'prop', 'labelStyle', 'noLabel', 'ItemComponentLayout', 'labelWidth', 'labelPosition', 'style']);
      ...
      return React.createElement(
        ...
        React.createElement(
          _flexbox2.default,
          _extends({}, remain, { flexDirection: mainLabelPosition === 'top' ? 'column' : 'row', alignItems: viceLabelPosition }),
          React.createElement(
            _flexbox2.default,
            null,
            React.createElement(
              'label',
              {
                className: (label && 'i-form-label') + ' ' + (this.isRequired && 'ant-form-item-required') + ' ' + (labelPosition === 'top' && 'i-form-label-top'),
                style: _extends({}, labelStyle, { width: labelWidth > 0 ? labelWidth : 'auto', textAlign: alignLabelPosition }),
                title: label,
                htmlFor: prop
              },
              label
