  ...
  _createClass(Form, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          remain = _objectWithoutProperties(_props, ['children', 'style', 'layout', 'fillCount', 'inline', 'labelWidth', 'labelPosition', 'manualLayout', 'actionPosition', 'needCls', 'labelStyle']);
      ...
      return _react2.default.createElement(
        _mobxReact.Provider,
        _extends({ fields: this.fields, duplexer: this.duplexer, rules: this.props.rules }, remain, { ItemComponentLayout: ItemComponentLayout, type: 'block', labelWidth: labelWidth, labelStyle: labelStyle, labelPosition: labelPosition }),
        manualLayout ? _react2.default.createElement(
          ...
          _react2.default.createElement(
            _flexbox2.default,
            { className: formCls, alignItems: mainActionPosition === 'right' ? alignActionPosition : 'flex-start' },
            _react2.default.createElement(
              ...
              formItems.map(function (formItemWrap, i) {
                ...
                return layout[2] === 'flex' ? _react2.default.createElement(
                  Block,
                  { key: 'form-item-wrap-' + i, className: 'i-form-item-wrap' },
            ...
            mainActionPosition === 'right' ? _react2.default.createElement(
              ...
              { style: { display: 'flex', alignItems: alignActionPosition, justifyContent: justifyActionPosition } },
              actions
            ) : null
          ),
          mainActionPosition === 'bottom' ? _react2.default.createElement(
            _flexbox2.default,
            { justifyContent: justifyActionPosition, alignItems: alignActionPosition, className: 'i-form-action' },
            actions
          ) : null
        )
      );
